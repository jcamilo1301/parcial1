...
--7.1: Traiga el nombre del barrio y el número de colegios ubicados en cada barrio de aquellas instituciones ubicadas en la comuna 
--de buenos aires ordenado por el número de colegios de mayor a menor.
